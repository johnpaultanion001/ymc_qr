      ...
      <div class="card">
        <div class="card-header border-0">
          <div class="row align-items-center">
            <div class="col-md-10">
              <h3 class="mb-0 text-uppercase" id="titletable">Animators List</h3>
            </div>
            <div class="col-md-2">
          ...
          <table class="table align-items-center table-flush datatable display" cellspacing="0" width="100%">
            ...
            <tbody class="text-uppercase font-weight-bold">
              @foreach($animators as $animator)
                    <tr>
                      <td>
                          <button id="{{$animator->id}}" class="btn btn-primary btn-sm  edit" >
                            VIEW/EDIT
                          </button>
                          <button  id="{{  $animator->id ?? '' }}" class="remove btn btn-sm btn-danger">REMOVE</button>
                      </td>
                      ...
                      <td>
                            {{  $animator->contact_number ?? '' }}
                      </td>
                      <td>
                          {{ $animator->created_at->format('M j , Y h:i A') }}
                      </td>
                    </tr>
                @endforeach
            </tbody>
...
<form method="post" id="myForm" class="contact-form">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="role" id="role" value="animator"  />
            </div>
